    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-white/50 mt-1">Vue d&apos;ensemble du marché Pokémon TCG</p>
        </div>
        <div className="flex items-center gap-3">
          <div className="px-4 py-2 glass rounded-xl">
            <span className="text-sm text-white/50">Market Health</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 glass rounded-2xl p-6">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-semibold text-white">Cartes Tendances</h2>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className={`text-sm font-medium ${alert.type === 'critical' ? 'text-red-400' :
                      ...
                      {alert.type === 'critical' ? 'CRITIQUE' : alert.type === 'warning' ? 'ATTENTION' : 'OPPORTUNITÉ'}
                    </p>
          ...
          <div className="mt-6 pt-6 border-t border-white/10">
            <div className="grid grid-cols-2 gap-4">
              <div className="p-3 bg-white/5 rounded-xl">
                <p className="text-xs text-white/50">Corr. Bitcoin</p>
      ...
      <div className="glass-strong rounded-2xl p-8 bg-gradient-to-r from-purple-500/10 to-blue-500/10">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-white">Analysez votre portefeuille</h2>
            <p className="text-white/60 mt-2 max-w-lg">
              Importez vos cartes et obtenez un score de spéculation global,
              des recommandations de rééquilibrage et des alertes personnalisées.
            </p>
          </div>
          <Link
            href="/portfolio"
